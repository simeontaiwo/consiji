	...
	var icons = [
		'images/blue-icon-map01.png', 
		'images/red-icon-map02.png', 
		'images/green-icon-map03.png', 			
		];
  ...
  google.maps.event.addListener(infowindow, 'domready', function() {
    ...
    */
    ...
    iwCloseBtn.css({opacity: '1', right: '50px', top: '15px', /*border: '7px solid #48b5e9', 'border-radius': '13px', 'box-shadow': '0 0 5px #3990B9'*/});
